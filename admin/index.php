...
<body>
	...
	<div class="container">
		...
		<a class="brand">
		<img src="./gallery/vote.png" width="60" height="60"  style="border-radius: 50px;">
 	</a>
	<a class="brand">
	 <h2>Voting System</h2>
...
<div class="wrapper_admin">
	...
	<tr><td>...<td></tr>
	<tr><td></td><td>
	<button class="btn btn-primary" name="Login"><i class="icon-ok icon-large"></i>&nbsp;Login</button><br><br>
	<button class="btn btn-primary" name="Login"><a href="../index.php" style="text-decoration:none; color:white;"><i class="icon-ok icon-large"></i>&nbsp;voter Login</a></button>
