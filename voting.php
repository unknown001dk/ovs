...
<font color="white">Candidate for Chiefminister</font>
</div>
<div class="governor">
...
<div class="gov-margin">
<?php
$vice=mysqli_query($conn,"select * from candidate where Position='Vice-Chiefminister'")or die(mysqli_error());
...
<div class="rep-align" style="display: none;">
